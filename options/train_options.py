...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--eval_epoch_freq', type=int, default=10, help='frequency of evaluating the latest results')
        # training parameters
        ...
        parser.add_argument('--pool_size', type=int, default=40, help='the size of image buffer that stores previously generated images')
